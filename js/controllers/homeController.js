  ...
  weatherService.getHourly($stateParams.state, $stateParams.city)
    .then(function(response){
      ...
      for(var i = 0; i < response.length; i++){
        ...
        else if(response[i].condition == 'Clear' || response[i].condition == 'Sunny' && response[i].hour > 21){
        ...
        else if(response[i].condition == 'Scattered Clouds' || response[i].condition == 'Partly Sunny' || response[i].condition == 'Partly Cloudy' || response[i].condition == 'Mostly Sunny' || response[i].condition == 'Mostly Cloudy' && response[i].hour > 21){
